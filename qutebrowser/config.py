...
c.url.searchengines = {
        ...
        'nr':'https://www.reddit.com/search?q={}',
        'or':'https://old.reddit.com/search?q={}',
...
quickmarks_file = '~/.config/qutebrowser/quickmarks'

with open(os.path.expanduser(quickmarks_file), 'w') as f:
